...
If the task doesn't belong to you, or haven't got the right status, you can try to take it.

 * git redmine review take XXX

If it succeed, then try to start again. Otherwise contact the manager to assign this task to you.
